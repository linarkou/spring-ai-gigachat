...
/**
 * Полная копия {@link org.springframework.ai.model.function.AbstractFunctionCallback}.
 * Скопирован, т.к. исходный класс package-private.
 *
...
abstract class AbstractFunctionCallback<I, O> implements BiFunction<I, ToolContext, O>, FunctionCallback {
     ...
     * from JSON.
     */
    protected AbstractFunctionCallback(
            String name,
            String description,
